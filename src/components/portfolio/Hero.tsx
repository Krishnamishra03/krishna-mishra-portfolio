    ...
    <section id="top" ref={ref} className="relative grain min-h-[100svh] overflow-hidden pt-28">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center px-6 pt-12 text-center md:pt-20">
        ...
        <motion.div
          ...
          className="mt-14 grid w-full max-w-5xl grid-cols-2 gap-3 md:grid-cols-4 md:gap-4"
        >
          {[
            ...
            <div
              key={stat.label}
              className="group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 transition-all duration-500 hover:border-white/[0.14] hover:bg-white/[0.05]"
            >
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-aurora/40 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
